  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Flex(
        direction: Axis.vertical,
        children: [
          Flexible(child: const CircleAvatar(
            radius: 50,
          ...
          Flexible(child: Text("Smith", style: textTheme.displayMedium)),
          Flexible(child: Text("Một matter flutter đẹp trai", style: textTheme.displaySmall)),
          Flexible(child: Container(
